...
void ocl_scalar_flux_(void)
{
	...
	*/
	err = meta_gen_opencl_ocl_kernels_reduce_angular( queue[0], &global, NULL, nx, ny,  nz, nang,  ng, noct, cmom,  &d_weights,  &d_scat_coeff, &d_flux_in[0],  &d_flux_in[1], &d_flux_in[2],  &d_flux_in[3], &d_flux_in[4], &d_flux_in[5], &d_flux_in[6], &d_flux_in[7],  &d_flux_out[0],  &d_flux_out[1], &d_flux_out[2],  &d_flux_out[3], &d_flux_out[4], &d_flux_out[5], &d_flux_out[6], &d_flux_out[7],  &d_time_delta,  &d_scalar_flux, &d_scalar_mom,0, NULL,3);
...
void reduce_angular_cells(void)
{
	...
	*/
	err= 	meta_gen_opencl_ocl_kernels_reduce_angular_cell( queue[0], &global, &local, nx, ny,  nz, nang,  ng, noct, cmom, size,  &d_weights,  &d_scat_coeff, &d_flux_in[0],  &d_flux_in[1], &d_flux_in[2],  &d_flux_in[3], &d_flux_in[4], &d_flux_in[5], &d_flux_in[6], &d_flux_in[7],  &d_flux_out[0],  &d_flux_out[1], &d_flux_out[2],  &d_flux_out[3], &d_flux_out[4], &d_flux_out[5], &d_flux_out[6], &d_flux_out[7],  &d_time_delta,  &d_scalar_flux, 0, NULL,2);
...
void reduce_moments_cells(void)
{
	...
	*/
        err= meta_gen_opencl_ocl_kernels_reduce_moments_cell( queue[0], &global, &local, nx, ny,  nz, nang,  ng, noct, cmom,  size, &d_weights,  &d_scat_coeff, &d_flux_in[0],  &d_flux_in[1], &d_flux_in[2],  &d_flux_in[3], &d_flux_in[4], &d_flux_in[5], &d_flux_in[6], &d_flux_in[7],  &d_flux_out[0],  &d_flux_out[1], &d_flux_out[2],  &d_flux_out[3], &d_flux_out[4], &d_flux_out[5], &d_flux_out[6], &d_flux_out[7] , &d_time_delta,  &d_scalar_mom, 0, NULL,2);
    }
	/*
